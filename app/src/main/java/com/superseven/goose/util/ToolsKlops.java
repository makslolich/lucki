package com.superseven.goose.util;
...
import com.superseven.goose.DataTablePreferences;
import com.superseven.goose.Messages;
import com.superseven.goose.R;
import com.superseven.goose.StartActivity;
...
public class ToolsKlops {
    ...
    public static void setPolicyLink(String l, Activity context) {
        DataTablePreferences dataTablePreferences = new DataTablePreferences(context);
        dataTablePreferences.setData("http://" + cutCharacter(l));
    ...
    private static String cutCharacter(String input) {
